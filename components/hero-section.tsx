    ...
    <section className="pt-32 pb-12 px-6 min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="flex flex-col items-center justify-center gap-6 mt-8">
          ...
          {/* Trust Badges */}
          <div
            className={`transition-all duration-1000 delay-1200 mt-4 md:mt-8 flex justify-center w-full ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            <div className="bg-background/40 backdrop-blur-sm p-5 md:p-4 rounded-2xl border border-primary/10 flex flex-col md:flex-row items-start md:items-center gap-5 md:gap-6 w-fit">
              <div className="flex items-center gap-3">
                <div className="flex-shrink-0 w-10 h-10 flex items-center justify-center bg-primary/10 rounded-full">
                  <Smartphone className="w-5 h-5 text-primary" />
                </div>
                <div className="text-left">
                  <h3 className="font-semibold text-foreground text-sm">10% Cashback</h3>
                  <p className="text-muted-foreground text-xs">on App orders</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <h3 className="font-semibold text-foreground text-sm">30 Days Return</h3>
                  <p className="text-muted-foreground text-xs">Easy Exchanges</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <h3 className="font-semibold text-foreground text-sm">Free & Fast</h3>
